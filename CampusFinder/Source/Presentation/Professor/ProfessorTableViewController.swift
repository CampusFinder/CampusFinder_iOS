...
final class ProfessorTableViewController: UITableViewController {
    deinit {
        print("deinit \(self)")
    }
    ...
    override func viewDidLoad() {
        ...
        tableView.register(ProfessorTableViewCell.self, forCellReuseIdentifier: "ProfessorTableViewCell")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "ProfessorTableViewCell", for: indexPath) as? ProfessorTableViewCell else {
